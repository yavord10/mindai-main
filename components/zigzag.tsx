...
import FeatImage05 from "@/public/images/masterapp.png";
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-xl text-gray-400 mb-4">
                    Swap USDT or ETH for $MAIM with low fees for only $0.001
                    compared to the public sale for $0.0005.
                  </p>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h3 mb-3">Mint Music NFTs</h3>
                  <p className="text-xl text-gray-400 mb-4">
                    We offer NFT minting for creators to turn their music into
                    NFT and sell them on any marketplace.
                  </p>
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      <svg
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Leave a unique trace with your art!</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Track all metrics of your songs!</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                      ...
                      <span>Access a wide range of AI tools!</span>
                    </li>
                    <li className="flex items-center">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
