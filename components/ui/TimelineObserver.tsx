...
function setObservable({ obs, observableList, callbacks }: any) {
...
function removeObservable({ obs, observableList }: any) {
...
function colorize({
  ...
  observableList.forEach((observable: any) => {
...
const TimelineObserver = ({
  ...
  const setObserver: any = (elem: HTMLElement, callbackFn?: () => void) => {
    ...
    (observer?.current as any)?.observe(elem);
